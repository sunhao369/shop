    ...
    <table class="layui-table x-admin">
       ...
       <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
           <tr>
               ...
               <td><?php echo e($v->product_image); ?></td>
               <td><?php echo e($v->current_price); ?></td>
...
<script>
    $(".del").click(function () {
        ...
        // alert(id);
        $.ajax({
            url:"http://www.shopping.com/index.php/orderdel",
            data:{
                id:id
            },
...
<?php /**PATH D:\store\shop\shop\resources\views/Admin/order.blade.php ENDPATH**/ ?>