...
<div class="qing tibg">
  <div class="juzhong gwc-tk">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tbody><tr>
        <td><img src="/index/images/pa1.png" width="273" height="19"></td>
        <td><img src="/index/images/pa2.png" width="362" height="19"></td>
        <td><img src="/index/images/pa30.png" width="615" height="19"></td>
      </tr>
    </tbody></table>
    <div class="qing chm">
  ...
  <div class="cenbg">
    <div class="qing">
      ...
      <div class="qing addk">
        ...
        <a href="/personage/address" class="add">
    ...
    <div class="qing fuk">
      ...
      <input type="hidden" name="pay_method" value="1" id="pay_method">
        <a href="#" id="pay_method_1" class="pay paynn">
          <img src="/index/images/pay1.png" width="160" height="60">
        </a>
        <a href="#" id="pay_method_2" class="pay"><img src="/index/images/pay2.png" width="160" height="60"></a>
        <a href="#" id="pay_method_2" class="pay"><img src="/index/images/pay3.png" width="160" height="60"></a>
      </div>
    </div>
    <!--配送方式 -->
    <div class="qing dizk">
    ...
    <div class="qing">
      <div class="qing">
        ...
        <a href="/personage/cart" class="rf hui">返回购物车<span> &gt;</span></a>
      </div>
      <div class="qing xcp">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tbody><tr>
            <td width="75"><img src="/index/images/484069aec.jpg" width="59" height="45"></td>
            <td width=""><a href="product-view.php?id=1351" class="dj-m1">2017-21《喜鹊》特种邮票小版票</a></td>
      ...
      <div class="qing fuyk0">
        ...
        <div class="rf fuyk">
          <div class="fu-you3 rf"><sapn>900.00元</sapn></div>
          <div class="fu-yu2 fu-yu3 rf">应付总金额：</div>
        </div>
      </div>
      <div class="qing rf"><a href="/personage/pay"><input type="button" value="确认并支付" class="jie2"></a></div>
    </div>
