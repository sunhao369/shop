  ...
  <div class="juzhong gwc-tk">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tbody><tr>
        ...
        <td><img src="/index/images/pa3.png" width="615" height="19"></td>
      </tr>
    </tbody></table>
    <div class="qing chm">
...
<div class="qing juzhong">
  ...
  <div class="cenbg">
    ...
    <div class="qing" style="width: 500px;margin: 50px auto;">
      <img src="/index/images/zfcg.png" width="100" style=" float:left;">
      <div style="float:left; margin-left:30px;">
      	<h1 style="font-size:20px;">支付成功！</h1>
        <p style="font-size:14px;">您的订单已经支付成功，请耐心等待卖家发货。</p>
        <a href="/personage/cart"><input type="button" value="继续购物" class="jie2" style="line-height:35px; margin-right:20px; border-radius:5px; height:35px; margin-top:10px; background:#666"></a>
        <a href="/personage/index"><input type="button" value="个人中心" class="jie2"  style="line-height:35px; margin-right:20px; border-radius:5px; height:35px; margin-top:10px;"></a>
      </div>
